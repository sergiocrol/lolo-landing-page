...
function LogoSignup({rectangle, circle, line, ...others }) {
  return (
    <svg
    ...
    >
      ...
      <g filter="url(#filterx_2)">
        <path fill={line} d="M15.768 6.852h4.794v22.52h-4.794V6.852z"></path>
      </g>
      <defs>
        <filter
          id="filterx_1"
